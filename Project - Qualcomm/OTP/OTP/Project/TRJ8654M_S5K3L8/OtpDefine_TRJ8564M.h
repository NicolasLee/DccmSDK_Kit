...
class COtpdefineTRJ8564M :  public COtpBase
{
public:
	enum normal
	{
	...
	enum TRJ8564M_OTP_SIZE
	{
		...
		SIZE_TOTAL_GROUP = 3519, //第一个Data到最后一个Data
	};

	enum TRJ8564M_REG_ADDR
	{
		GAIN_ADDR_GR = 0x020e,
		GAIN_ADDR_R  = 0x0210,
		GAIN_ADDR_B  = 0x0212,
...
// 	TRJ8564M_ADDR_GAIN_GR_H = 0x0508,
// 	TRJ8564M_ADDR_GAIN_GR_L = 0x0509,	
// 	TRJ8564M_ADDR_GAIN_R_H  = 0x050C,
// 	TRJ8564M_ADDR_GAIN_R_L  = 0x050D,
// 	TRJ8564M_ADDR_GAIN_B_H  = 0x050E,
// 	TRJ8564M_ADDR_GAIN_B_L  = 0x050F,
// 	TRJ8564M_ADDR_GAIN_GB_H = 0x050A,
// 	TRJ8564M_ADDR_GAIN_GB_L = 0x050B,
	};

	enum TRJ8564M_OTP_FLAG
	{
		FLAG_EMPTY = 0x00,
		FLAG_VALID = 0x80,

// 	TRJ8564M_FLAG_GROUP1 = 0x01,
// 	TRJ8564M_FLAG_GROUP2 = 0x13,
// 	TRJ8564M_FLAG_GROUP3 = 0x37,
	};

	enum TRJ8564M_OTP_REG_ADDR
	{
	...
	typedef struct _TRJ8564MOTPDataSpec//包含数据和Checksum
	{
	...
	typedef union TRJ8564MEEPROMOtpGroupUnion
	{

...
// 	control->enMTKLSC = TRUE;//应拉接口到桌面上 
	...
	wbCtrl->roiCalcMode = m_awb_size;//可以拉出接口
...
// 		//PDAF1
		...
		Data_Write.data_PDAF1[SIZE_PDAF_PROC1] = sum;//checksum在reserve前面
// 
		//L3PDAF1
// 		sum = SumCalc(OTP_Data_Write.LPDAF1,SIZE_LPDAF_GROUP1-1,255,0);
// 		Data_Write.data_LPDAF1[SIZE_LPDAF_GROUP1-1] = sum;//checksum在reserve前面

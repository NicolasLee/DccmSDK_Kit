...
#include <vector>
#include <Windows.h>
#include "OtpDefine_HLT7109.h"

class COtpHLT7109 : public COtpdefineHLT7109
{
public:
	COtpHLT7109(void);
	~COtpHLT7109(void);
	...
	BOOL HLT7109_GetAWBData(HLT7109OTPDataSpec &awbdata);
	BOOL HLT7109_GetCurrentAWB(tagAwbRatio* wb);
	BOOL HLT7109_CheckAWB(tagAwbRatio wb,int type);

	/////////////////////////////Burning/////////////////////////////////////////
	void   CreateBurningData(void);
	void   HLT7109_GetBasicData(void);
	void   HLT7109_GetAFData(void);
	void   HLT7109_CalcAllCheckSum(void);
	BOOL HLT7109_OtpWrite(void);
	BOOL WriteOTP(void);
	...
	void HLT7109_WriteLSCFlagSum(void);
	...
	/////////////////////////////////Verify/////////////////////////////////////
	BOOL CheckOTP(void);
	BOOL HLT7109_OTPVerify(void);
	BOOL HLT7109_CheckOTPReadWrite(void);
	BOOL Sensor3L8_CheckReadWrite(void);
	BOOL Sensor3L8_CheckLSCReadWrite(void);
	BOOL HLT7109_VerifyLSC();
	BOOL HLT7109_VerifyAWB();
	BOOL VerifyLSC(void);
...
private:
	...
	HLT7109OTPDataSpec  OTP_Data_Write,OTP_Data_Read;
...
// 	WORD m_flagGroup3;
	...
	BYTE HLT7109_LSCWriteData[1868];
	BYTE HLT7109_LSCReadData[1868];
	int HLT7109_LSCchecksum;
};
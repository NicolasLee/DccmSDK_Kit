...
{
	SIZE_BASIC_GROUP = 8, //除掉Flag的所有数据
	SIZE_WB_GROUP = 7, //除掉Flag的所有数据
//	SIZE_LSC = 512,
	SIZE_LSC_GROUP = 1, //除掉Flag的所有数据
...
enum S5K3L8_OTP_REG_ADDR
{
	...
	REG_BASIC_CHECKSUM = 0x0A05,
	REG_WB_FLAG = 0x0A0D,//TBD
	REG_WB_CHECKSUM = REG_INVALID,
	REG_LSC_FLAG = 0x0A1A,
	REG_LSC_CHECKSUM = 0x0A1B,
	REG_AF_FLAG = 0x0A15,
	REG_AF_CHECKSUM = 0x0A16,

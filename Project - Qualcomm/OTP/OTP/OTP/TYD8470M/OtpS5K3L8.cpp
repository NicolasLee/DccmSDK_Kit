...
void COtpS5K3L8::CreateBurningData(void)
{
	...
	for (i = 0; i < SIZE_BASIC_GROUP-1; i++)
	{
		Data_Write.data_Basic[i+2] = OTP_Data_Write.BaseInfo[i];
	}
	//////////////////////////////////AWB//////////////////////////////////////
	Data_Write.data_WB[0] = FLAG_EMPTY;
	...
	for (i = 0; i < SIZE_AF_GROUP-1; i++)
	{
		Data_Write.data_AF[i+2] = OTP_Data_Write.AFInfo[i];
	}
	//////////////////////////////////PDAF////////////////////////////////////
	if (m_EnPDAF)
	{
...
// 	OTP_Data_Write.BaseInfo[8] = BASIC_COLORTEMP;
...
BOOL COtpS5K3L8::S5K3L8_OtpWrite(void)
{
	...
	if (!ProgrammingBasic())  return FALSE;//cnw2

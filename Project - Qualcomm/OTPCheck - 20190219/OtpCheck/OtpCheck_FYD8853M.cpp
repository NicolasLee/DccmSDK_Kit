...
int OtpCheck_FYD8853M::CheckSum(BOOL flag,int flagaddr, int sumaddr, int datasize, int gap, CString str, int validgroup)//检测多组checksum
{
...
void OtpCheck_FYD8853M::SaveOTPData()//点亮后读取模组内的OTP数据
{

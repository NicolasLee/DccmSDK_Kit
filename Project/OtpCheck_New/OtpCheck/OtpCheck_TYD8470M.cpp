...
OtpCheck_TYD8470M::OtpCheck_TYD8470M(void)
{
	m_slaveSensor = 0x0;
	m_slaveEeprom = 0xA0;
	m_modeSensor = 0;
...
//	m_pageSize = 0x40;	// 0x00~0x3f
	...
	m_flagEmpty	= 0xFF;	// valid:0x80 empty: 0x00
...
BOOL OtpCheck_TYD8470M::Check_ModuleInfo()
{
	//m_pInterface->AddDebugLog(L"TYD8470M Check_ModuleInfo");
...
BOOL OtpCheck_TYD8470M::Check_AWB()
{
	//m_pInterface->AddDebugLog(L"TYD8470M Check_AWB");
...
BOOL OtpCheck_TYD8470M::Check_LSC()
{
	//m_pInterface->AddDebugLog(L"TYD8470M Check_LSC");
...
BOOL OtpCheck_TYD8470M::Check_AF()
{
	//m_pInterface->AddDebugLog(L"TYD8470M Check_AF");
...
BOOL OtpCheck_TYD8470M::Check_PDAF()
{
	//m_pInterface->AddDebugLog(L"TYD8470M Check_PDAF");
...
BYTE OtpCheck_TYD8470M::SumCalc(BYTE* pVal, int valSize)
{
	ULONGLONG sum = 0;
...
#ifdef IIC_SENSOR_TYD8470M
BOOL OtpCheck_TYD8470M::ReadSensor_Byte(WORD reg, BYTE* val)
{
	//m_pInterface->AddDebugLog(L"TYD8470M ReadSensor_Byte");
	return TRUE;
}

BOOL OtpCheck_TYD8470M::ReadSensor_Word(WORD reg, WORD* val)
{
	//m_pInterface->AddDebugLog(L"TYD8470M ReadSensor_Word");
	return TRUE;
}

BOOL OtpCheck_TYD8470M::WriteSensor_Byte(WORD reg, BYTE val)
{
	//m_pInterface->AddDebugLog(L"TYD8470M WriteSensor_Byte");
	return TRUE;
}

BOOL OtpCheck_TYD8470M::WriteSensor_Word(WORD reg, WORD val)
{
	//m_pInterface->AddDebugLog(L"TYD8470M WriteSensor_Word");
	return TRUE;
}

BYTE OtpCheck_TYD8470M::ReadSensor_MultiBytes(WORD reg, BYTE regSize, BYTE *pVal, WORD valSize, BOOL bStop /* = FALSE */)
{
	//m_pInterface->AddDebugLog(L"TYD8470M ReadSensor_MultiBytes");
	return TRUE;
}

BYTE OtpCheck_TYD8470M::WriteSensor_MultiBytes(WORD reg, BYTE regSize, BYTE *pVal, WORD valSize)
{
	//m_pInterface->AddDebugLog(L"TYD8470M WriteSensor_MultiBytes");
	return TRUE;
}

#else
BOOL OtpCheck_TYD8470M::ReadEeprom_Byte(WORD reg, BYTE* val)
{
...
BOOL OtpCheck_TYD8470M::WriteEeprom_Byte(WORD reg, BYTE val)
{
...
// BOOL OtpCheck_TYD8470M::ReadEeprom_Byte(WORD reg, BYTE* val, BYTE page)
// {
// 	//m_pInterface->AddDebugLog(L"TYD8470M ReadEeprom_Byte");
// 
// 	BOOL bRet = TRUE;
// 	WORD readVal = 0;
...
// }
// 
// BOOL OtpCheck_TYD8470M::WriteEepromPage_Byte(WORD reg, BYTE val, BYTE page)
// {
// 	//m_pInterface->AddDebugLog(L"TYD8470M WriteEepromPage_Byte");
// 
// 	BOOL bRet = TRUE;
...
// }
/*
BOOL OtpCheck_TYD8470M::ReadEepromPage_Word(WORD reg, WORD* val, BYTE page)
{
	//m_pInterface->AddDebugLog(L"TYD8470M ReadEepromPage_Word");
...
BOOL OtpCheck_TYD8470M::WriteEepromPage_Word(WORD reg, WORD val, BYTE page)
{
	//m_pInterface->AddDebugLog(L"TYD8470M WriteEeprom_Word");
...
*/
// BYTE OtpCheck_TYD8470M::ReadEepromPage_MultiBytes(WORD reg, BYTE regSize, BYTE *pVal, WORD valSize, BYTE page, BOOL bStop /* = FALSE */)
// {
// 	//m_pInterface->AddDebugLog(L"TYD8470M ReadEepromPage_MultiBytes");
// 
// 	BOOL bRet = TRUE;
// 	WORD curReg = 0;
...
// BYTE OtpCheck_TYD8470M::WriteEepromPage_MultiBytes(WORD reg, BYTE regSize, BYTE *pVal, WORD valSize, BYTE page)
// {
// 	//m_pInterface->AddDebugLog(L"TYD8470M WriteEeprom_MultiBytes");
// 
// 	BOOL bRet = TRUE;
// 	WORD curReg = 0;
// 	for (int i = 0, j = 0; i < valSize; i++)
...
BOOL OtpCheck_TYD8470M::CheckFlag_ModuleInfo()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckFlag_ModuleInfo");
...
BOOL OtpCheck_TYD8470M::CheckFlag_AWB()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckFlag_AWB");
...
BOOL OtpCheck_TYD8470M::CheckFlag_LSC()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckFlag_LSC");
...
BOOL OtpCheck_TYD8470M::CheckFlag_AF()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckFlag_AF");
...
BOOL OtpCheck_TYD8470M::CheckFlag_PDAF()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckFlag_PDAF_Step1");
...
BOOL OtpCheck_TYD8470M::CheckFlag(BOOL flag,int addr,CString str)
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckFlag_PDAF_Step1");
	if (!flag) return TRUE;
...
BOOL OtpCheck_TYD8470M::CheckSum_ModuleInfo()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckSum_ModuleInfo");
	...
	bRet &= GT24C64_Read(regAddr+1, pVal, valSize);
...
BOOL OtpCheck_TYD8470M::CheckSum_AWB()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckSum_AWB");
...
BOOL OtpCheck_TYD8470M::CheckSum_LSC()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckSum_LSC");
...
BOOL OtpCheck_TYD8470M::SaveLSCData(BYTE *pVal, int valSize)
{
...
BOOL OtpCheck_TYD8470M::SaveOTPData()
{
	m_pInterface->AddLog(_T("Read OTP Start!"));
	///////////////////////////////Read OTP////////////////////////////////////
	int valSize = 3519;
	BYTE* pVal = new BYTE[valSize];
	if (!GT24C64_Read(0000, pVal, valSize))
	{
...
BOOL OtpCheck_TYD8470M::CheckAbnormal(BYTE *pVal, int valSize)
{
	//check 连续为0或ff判断为异常
...
BOOL OtpCheck_TYD8470M::CheckSum_AF()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckSum_AF");
...
BOOL OtpCheck_TYD8470M::CheckSum_PDAF_Step1()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckSum_PDAF_Step1");
...
BOOL OtpCheck_TYD8470M::CheckSum_PDAF_Step2()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckSum_PDAF_Step2");
	if (!m_bCheckSum_PDAF) return TRUE;
	...
	BYTE* pVal = new BYTE[valSize];
	bRet &= GT24C64_Read(regAddr, pVal, valSize);
...
BOOL OtpCheck_TYD8470M::CheckCode_Stc()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckCode_Stc");
...
BOOL OtpCheck_TYD8470M::CheckCode_Inf()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckCode_Inf");
...
BOOL OtpCheck_TYD8470M::CheckCode_Mac()
{
	//m_pInterface->AddDebugLog(L"TYD8470M CheckCode_Mac");

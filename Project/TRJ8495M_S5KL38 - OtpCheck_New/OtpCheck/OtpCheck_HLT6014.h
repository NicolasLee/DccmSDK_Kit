#pragma once
#define IIC_SENSOR_HLT6014 0
#include "OtpCheckBase.h"

#define  OTP_GAP 32

class OtpCheck_HLT6014 :public OtpCheckBase
{
public:
	OtpCheck_HLT6014(void);
	~OtpCheck_HLT6014(void);
...
private:
	...
	void Read3L8Sensor_Byte(WORD reg, BYTE* val);
	void Read3L8Sensor_Group(USHORT address,BYTE *Data,int size);
